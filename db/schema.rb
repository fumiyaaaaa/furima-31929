...
ActiveRecord::Schema.define(version: 2021_04_03_014421) do
  ...
  create_table "buyer_informations", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["order_history_id"], name: "index_buyer_informations_on_order_history_id"
  end
  ...
  add_foreign_key "buyer_informations", "order_histories"
